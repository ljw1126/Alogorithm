...
public class Main {
    ...
    private static TreeSet<Problem> PROBLEMS = new TreeSet<>(asc());
    ...
    private static TreeSet<Problem> findGroup(int groupNo) {
        ...
        TreeSet<Problem> newGroup = new TreeSet<>(desc());
        GROUP_PROBLEM.put(groupNo, newGroup);
        return newGroup;
    }

    private static Comparator<Problem> desc() {
        return (o1, o2) -> {
    ...
    private static Comparator<Problem> asc() {
        return (o1, o2) -> {
